<x-app-layout>
    ...
    <form method="POST" action="{{ url('/admin/aktuelles/'.$news->id.'/update') }}" enctype='multipart/form-data'>
        @csrf
        @method('PUT')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 row form-group">
                    ...
                    <img src="{{URL::asset('images/aktuelles/'.$news->image)}}" width="320px" height="240px">
                    </div>
                </div>
