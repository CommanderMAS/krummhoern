        ...
        <div class="max-w-7xl mx-auto">
            <div class="dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="row text-white align-content-center">
                    <a href="{{ url('admin/projekte/new') }}" class="btn btn-primary mx-auto w-75">Neuen Aktuelles-Eintrag
                        erstellen</a>
                        ...
                        <table id="bootstrap-data-table"
                            ...
                            @foreach ($news as $info)
                                <tr role="row" class="{{$row++ % 2 == 0?"even":"odd"}}">
                                    ...
                                    <td class="text-center"><img src="{{URL::asset('images/projekte/'.$info->image)}}"
